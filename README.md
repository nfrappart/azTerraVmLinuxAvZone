# Linux Server Module
This module allows you to create 1 Linux Server VM with 1 NIC based on provided list
...
```hcl
module "testVM" {
  source = "git::ssh://git@ssh.dev.azure.com/v3/Covage-dsi-infra/iac-terraform-modules/TerraVmLinuxAvZone"
